...
import { IFormBankSoal, IFormBankSoalGroup } from '../bank-soal.interface';
...
const BankSoalCreate = () => {
    ...
    const onSubmitGroup = (values: IFormBankSoalGroup) => {
        reactForm.reset({
            title: '',
            desc: '',
            tag: { value: '', label: '' },
    ...
    return (
        <>
            ...
            <ModalToast
                ...
                description={
                    'Apakah Soal-Soal yang kamu buat mau dijadikan Group ??'
                }
                onClose={() => {
                    nav('/bank-soal')
                }
