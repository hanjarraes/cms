...
const SoalCard = ({ item, onEdit, onDelete, onPreview }: any) => {
...
const BankSoal = () => {
    ...
    const filteredSoal = dummyBankSoal.filter((item) =>
            ...
            <div className="max-w-5xl  mx-auto space-y-3">
                ...
                <div className="flex flex-col gap-2 h-[calc(100vh-10rem)] overflow-y-auto pr-2 mt-0">
                    {filteredSoal.map((item, idx) => (
                        ...
                        //                 <i className="ri-eye-line hover:text-[--info-v6] cursor-pointer" onClick={() => nav('/bank-soal-create')} />
                        //                 <i className="ri-edit-2-line hover:text-[--info-v6] cursor-pointer" onClick={() => modalPreview.openModalHandling()} />
