...
const Periode = () => {
    ...
    const filteredQuizzes = dummyPeriodeData.filter((quiz) =>
        quiz.years.toLowerCase().includes(search.toLowerCase())
    );
            ...
            <div className="max-w-5xl mx-auto space-y-6">
                ...
                <div className="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-1 gap-2 max-h-[800px] overflow-y-auto pr-2 py-4 mt-0">
                    {filteredQuizzes.map((item) => (
                        <div className='shadow-sm border-[1px] bg-white p-2 rounded-md transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-lg cursor-pointer hover:bg-[--blue-v1]'>
