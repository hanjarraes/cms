...
import { dummyOptionsSoal, dummyTemplateSoal, dummyCheckboxSoal, dummyTextSoal, dummyFileSoal, dummyCodeSoal } from './template.dummy';
import ModalToast from 'component/modal-massage/modal-massage';
import useTemplateSoal from './template.service';
...
const TemplateCard = ({ item, onEdit, onDelete, onPreview }: any) => {
...
const TemplateSoal = () => {
    ...
    const filteredQuizzes = dummyTemplateSoal.filter((item) =>
        item.title.toLowerCase().includes(search.toLowerCase())
    );
    const service = useTemplateSoal()
    const {
        nav,
        isDelete,
        setIsDelete,
            ...
            <div className="max-w-5xl  mx-auto space-y-3">
                <Card>
                    <div className='flex justify-between items-center gap-2 px-2'>
                        <div className='text-[24px] font-bold'> Template Soal </div>
                ...
                >
                    <div className="space-y-4">
                        <div className='flex justify-between border-b px-4 py-3 bg-animasi'>
                            <div className='text-[18px] font-bold'> Preview Template</div>
                            <i
