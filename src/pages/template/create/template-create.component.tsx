...
import { DragItem, IFormTemplateSoal, ITemplateSoalState } from '../template.interface';
...
import useTemplateSoalCreate from './template-create.service';
...
const TemplateSoalCreate = () => {
    const nav = useNavigate()
    const [soalDnd, setSoalDnd] = useState<ITemplateSoalState>({
        listData: {
            id: 1,
            title: 'List Soal',
            items: [...dummyBankSoal],
    ...
    const onSubmit = (values: IFormTemplateSoal) => {
        reactForm.reset({
            title: '',
            desc: '',
            tag: undefined,
                        ...
                        {isStep.value === 'informasi' ? (
                            <div className='flex flex-col gap-3 border-[1px] pt-4 px-3 pb-2 rounded-md  w-[500px]'>
                                <div className='flex justify-between '>
                                    <div className='text-[16px] font-bold flex items-center'>INFORMASI TEMPLATE</div>
                                </div>
...
export default TemplateSoalCreate;
