...
import { IFormSchedule, IUseSchedule } from '../schedule.interface';
...
const SchaduleCreate = ({ service }: { service: IUseSchedule }) => {
    ...
    const onSubmit = (values: IFormSchedule) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className='flex justify-between mb-4 border-b px-4 py-3 bg-animasi'>
                <div className='text-[18px] font-bold'>Create Schedule</div>
                <i
